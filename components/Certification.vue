<template>
  <v-container class="py-4">
    <v-card elevation="2">
      <v-card-title>證照 Certification</v-card-title>
      <v-card-text>
        <h3>Computer Skills</h3>
        <v-list density="compact">
          <v-list-item v-for="item in skills" :key="item">
            <v-list-item-title v-html="item"></v-list-item-title>
          </v-list-item>
        </v-list>
        <h3>Management</h3>
        <v-list density="compact">
          <v-list-item v-for="item in mgmt" :key="item">
            <v-list-item-title v-html="item"></v-list-item-title>
          </v-list-item>
        </v-list>
        <h3>Language</h3>
        <v-list density="compact">
          <v-list-item v-for="item in lang" :key="item">
            <v-list-item-title v-html="item"></v-list-item-title>
          </v-list-item>
        </v-list>
      </v-card-text>
...
const skills = [
  ...
  '<img src="imgs/InfiniBandEssentials.png" alt="NVIDIA Infiniband Essential" title="NVIDIA Infiniband Essential" height="60" />',
];
const mgmt = [
